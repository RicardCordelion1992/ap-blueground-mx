...
// that's the "yo controlo quién entra" requirement. The one exception is a
// completely empty table (brand-new deploy): the very first person ever to
// log in becomes ADMIN, so there's always a way to get in and start adding
// people from the Usuarios screen.
